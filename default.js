...
var last_dame = getCookie('lastDate');
if(last_date)
{
...
{
  opt = document.querySelector('oprion[value="other.html"]');
}
else
{
  opt = document.querySelector('oprion[value="index.html"]');
}
opt.selected = true;

dicument.getElementById('form').select.onchange = function()
{
